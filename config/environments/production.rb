...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "plato_production"
  ...
  config.action_mailer.smtp_settings = {
    ...
    domain: ENV.fetch('PLATO_SMTP_DOMAIN', nil),
    user_name: ENV.fetch('PLATO_SMTP_USERNAME', nil),
    password: ENV.fetch('PLATO_SMTP_PASSWORD', nil),
